...
Full documentation - https://www.gadgetronicx.com/reflex-sensei-arduino-powered-trainer-game
  ...
  while(1) // runs until the player presses a button
  {
    ...
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col1)==1); //wating until the player release the pressed button
              return 'F'; // returns the second character associated with the button
          }
        }
        return 'E';  // returns the first character associated with the button
    }
    else if(digitalRead(col2)==1)   
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col2)==1); //wating until the player release the pressed button
              return 'H'; // returns the second character associated with the button
          }
        }
        return 'G';  // returns the first character associated with the button
    }
    else if(digitalRead(col3)==1)   
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col1)==1); //wating until the player release the pressed button
              return 'J'; // returns the second character associated with the button
          }
        }
        return 'I';  // returns the first character associated with the button
    }
    else if(digitalRead(col4)==1)   
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col1)==1); //wating until the player release the pressed button
              return 'L'; // returns the second character associated with the button
          }
        }
        return 'K';  // returns the first character associated with the button
    }
    ...
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col1)==1); //wating until the player release the pressed button
              return 'N'; // returns the second character associated with the button
          }
        }
        return 'M';  // returns the first character associated with the button
    }
    else if(digitalRead(col2)==1)   
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col2)==1); //wating until the player release the pressed button
              return 'P'; // returns the second character associated with the button
          }
        }
        return 'O';  // returns the first character associated with the button
    }
    else if(digitalRead(col3)==1)   
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col3)==1); //wating until the player release the pressed button
              return 'R'; // returns the second character associated with the button
          }
        }
        return 'Q';  // returns the first character associated with the button
    }
    else if(digitalRead(col4)==1)   
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col4)==1); //wating until the player release the pressed button
              return 'T'; // returns the second character associated with the button
          }
        }
        return 'S';  // returns the first character associated with the button
    }
    ...
    {  // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {   // if the same button is pressed 
              while(digitalRead(col1)==1); //wating until the player release the pressed button
              return 'V'; // returns the second character associated with the button
          }
        }
        return 'U';  // returns the first character associated with the button
    }
    else if(digitalRead(col2)==1)
    { 
       // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {  // if the same button is pressed 
              while(digitalRead(col2)==1);//wating until the player release the pressed button
              return 'X';  // returns the second character associated with the button
          }
        }
        return 'W';   // returns the first character associated with the button
    }
    else if(digitalRead(col3)==1) 
    {   
        // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
        ...
        { delay(10);
          ...
          {  // if the same button is pressed 
              while(digitalRead(col3)==1);  //wating until the player release the pressed button
              return 'Z';  // returns the second character associated with the button
          }
        }
        return 'Y';  // returns the first character associated with the button
    }
    else if(digitalRead(col4)==1) 
    {   
        // these buttons have multiplexed characters each time it cheaks wheater it is pressed one more time
...
void level_change()
{
  ...
  int i=0;
  while(i<3){		// blinking three times all leds to indicate the level change
  digitalWrite(button1,HIGH);
  digitalWrite(button2,HIGH);
  digitalWrite(button3,HIGH);
  digitalWrite(button4,HIGH);
